...
#sides_of_agreement(
  tenant: (
    ...
    address_of_residence: "Україна, Волинська обл., м. Луцьк, вул. Володимира Великого, 63",
    passport_data: (
      series: "-",
      number: "4323424322",
  ...
  landlord: (
    ...
    address_of_residence: "Україна, Львівська обл., м. Львів, вул. Сахарова, 33",
    passport_data: (
      series: "-",
      number: "5489939439",
...
#signatures(
  tenant: (
    ...
    phone_number: "+380963211727",
    email: "nazar.demchuk@gmail.com"
  ),
  landlord: (
    initials: "Скіра Володимир Васильович",
    address_of_residence: "Україна, Львівська обл., м. Львів, вул. Сахарова, 33",
...
#appendix_one(
  appendix_one_data: (
    ...
    additional_property: (
      "Пральна машинка (Philips Wash 2015)": (
        "uah_price": 10000,
        "amount": 1
        ),
      "Кондиціонер (AERO 2020)": (
        "uah_price": 12000,
        "amount": 2
        ),
    ),
