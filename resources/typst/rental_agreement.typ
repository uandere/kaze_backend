...
#let sides_of_agreement(
  ...
  *Орендодавець:* #tenant.initials, який проживає за адресою: #tenant.address_of_residence, та має наступні паспортні дані: cерія: #tenant.passport_data.series, номер: #tenant.passport_data.number, виданий державним органом: #tenant.passport_data.issuing_authority, надалі *Орендодавець*, з одного боку, і
 
  *Орендар:* #landlord.initials, який проживає за адресою: #landlord.address_of_residence, та має наступні паспортні дані: cерія: #landlord.passport_data.series, номер: #landlord.passport_data.number, виданий державним органом: #landlord.passport_data.issuing_authority, надалі *Орендар*, з іншого боку (разом *Сторони*), уклали цей Договір про наступне:
]
...
#let other_conditions(other_conditions_data: dictionary) = [
  ...
  #for value in other_conditions_data.all_tenants [
    #h(1em) - *#value*
    #linebreak()
  ]
  #h(1em) Зазначені особи набувають рівних з Орендарем прав і обов’язків щодо користування Об’єктом нерухомості.
  ...
  #for value in other_conditions_data.allowed_animals [
    #h(1em) - #value
    #linebreak()
  ]
