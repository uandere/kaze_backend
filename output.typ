...
#rental_agreement_place_and_date(place: "", date: datetime(day: 12, month: 2, year: 2025))
...
#subject_of_agreement(real_estate_data: (type: "", address: "Україна,  обл., м. ,  р-н, вул.  ", area: 0), ownership_record: (number: "34983948", date: datetime(day: 19, month: 5, year: 2022)))
...
#appendix_one(appendix_one_data: (starting_date: datetime(day: 12, month: 2, year: 2025), place: "", tenant_initials: "Дія Надія Володимирівна", landlord_initials: "Дія Надія Володимирівна", additional_property: (), meter_readings: (electricity: (type: "TripleRate", readings: (10, 20, 30)), water: (type: "DualRate", readings: (100, 200)), heating: (type: "SingleRate", readings: (10)), gas: (type: "SingleRate", readings: (10)))))

#appendix_two(appendix_two_data: (starting_date: datetime(day: 12, month: 2, year: 2025), place: "", tenant_initials: "Дія Надія Володимирівна", landlord_initials: "Дія Надія Володимирівна"))
